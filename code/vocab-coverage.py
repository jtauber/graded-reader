...
# needed - maps a given coverage ratio to a list which, for each target, gives the least frequent word necessary to reach
# that coverage ratio for that target
needed = {}
...
# that means that to achieve 50% coverage, the first target needs up to the 16th most frequent word,
# the second target needs up to the 44th most frequent word, the third target needs up to the 182nd most frequent word,
# and so on...
